	...
	public class Preferences
	{
		...
		public static void GetPreferences()
		{
			try
			{
				...
				key = Microsoft.Win32.Registry.CurrentUser.OpenSubKey("Software\\Junkosoft\\CardGames\\Reno", false);
		...
		{
			Microsoft.Win32.RegistryKey key;
			key = Microsoft.Win32.Registry.CurrentUser.OpenSubKey("Software\\Junkosoft\\CardGames\\Reno", true);
		...
		private static void DoPreferencesReset()
		{
			_showMoney = false;
			_autoMove = false;
			Microsoft.Win32.Registry.CurrentUser.CreateSubKey("Software\\Junkosoft\\CardGames\\Reno");
			SetPreferences();
		}
		#endregion
	}
